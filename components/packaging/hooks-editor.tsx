    ...
    <section className="flex flex-col gap-2" aria-labelledby={`${addId}-heading`}>
      ...
      >
        ...
        <textarea
          ...
          className="min-w-0 flex-1 resize-y rounded-input border border-border bg-background px-3 py-2 font-display text-base leading-relaxed outline-none placeholder:font-sans placeholder:text-sm focus-visible:ring-2 focus-visible:ring-accent"
        />
        <button
          type="submit"

    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex items-center gap-2">
        <select
          ...
          className="min-w-0 flex-1 rounded-input border border-border bg-background px-3 py-2 text-base outline-none focus-visible:ring-2 focus-visible:ring-accent aria-busy:opacity-60 thumb:min-h-11"
        >
          {knowsCurrent ? null : (

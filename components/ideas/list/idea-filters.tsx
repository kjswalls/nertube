...
export function IdeaFilterBar({
  ...
  */
  ...
  const selectClass =
    "rounded-input border border-border bg-surface px-2 py-1 text-[12px] text-foreground outline-none focus-visible:ring-2 focus-visible:ring-accent max-md:text-base thumb:text-base thumb:min-h-11";
    ...
    >
      <label className={labelClass} htmlFor={searchId}>
        ...
        <input
          ...
          className="w-56 rounded-input border border-border bg-surface px-2 py-1 text-[12px] text-foreground outline-none placeholder:text-muted focus-visible:ring-2 focus-visible:ring-accent max-md:text-base thumb:text-base thumb:min-h-11"
        />
      </label>

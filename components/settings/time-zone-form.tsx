    ...
    >
      ...
      >
        ...
        <select
          ...
          className="min-w-0 flex-1 rounded-input border border-border bg-background px-3 py-2 text-base outline-none focus-visible:ring-2 focus-visible:ring-accent md:pointer-fine:text-[13px] thumb:min-h-11"
        >

      ...
      <nav aria-label="Month" className="flex items-center gap-1">
        ...
        {month === currentMonth ? null : (
          <Link
            ...
            className="rounded-button border border-border px-2 py-1 text-[12px] outline-none hover:bg-surface focus-visible:ring-2 focus-visible:ring-accent thumb:inline-flex thumb:min-h-11 thumb:items-center"
          >
            This month
          </Link>
        )}
